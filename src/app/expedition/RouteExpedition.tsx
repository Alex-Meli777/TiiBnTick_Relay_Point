...
export default function RouteSelectionStep({
  ...
  const handleSubmit = () => {
    ...
    if (finalRouteData.distanceKm > 0) {
      onContinue(finalRouteData, travelPrice);
    }
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Itinéraire calculé à partir des adresses fournies.
            </p>
          </div>
        </div>
      </div>
                  ...
                  {routeData.durationMinutes &&
                    routeData.durationMinutes > 0 && (
                      <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div>
                          <p className="text-xs text-gray-500 dark:text-gray-400">
                            Durée de route estimée
                          </p>
                          <p className="font-semibold text-gray-800 dark:text-gray-100">
                            {routeData.durationMinutes} minutes
                          </p>
                        </div>
                      </div>
                    )}
