...
import { User, Phone, Mail, MapPin, Home, ArrowRight, Send, Sparkles, Circle, UserPlus, X, Globe, Building, Navigation, ArrowLeft } from 'lucide-react';
...
import { Store } from 'lucide-react'; // An icon for Relay Point
...
export default function SenderInfoStep({ initialData, onContinue, onBack, currentUser }: SenderInfoStepProps) {
    ...
    <>
      <div className="min-h-screen bg-transparent relative overflow-hidden transition-colors duration-300">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
          ...
          >
            <motion.div
              className="bg-white/70 dark:bg-gray-800/60 backdrop-blur-xl rounded-2xl shadow-xl dark:shadow-2xl dark:shadow-orange-900/10 border border-white/50 dark:border-gray-700/50 p-6 sm:p-8"
              initial={{ y: 20 }}
              animate={{ y: 0 }}
            ...
            >
              ...
              <div className="mb-6 flex flex-col items-center justify-center bg-orange-50 dark:bg-orange-900/20 p-4 rounded-xl border border-orange-100 dark:border-orange-800/30">
                <div
                  className={`flex items-center space-x-3 cursor-pointer ${isLocating ? "opacity-50 pointer-events-none" : ""}`}
                  onClick={() => {
                ...
                >
                  <div
                    className={`relative w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${isSender ? "border-orange-600 bg-orange-600" : "border-gray-400 bg-white"}`}
                  >
                    {isLocating ? (
                  ...
                  <span
                    className={`font-medium ${isSender ? "text-orange-700 dark:text-orange-400" : "text-gray-600 dark:text-gray-300"}`}
                  >
                    {isLocating
                      ? "Acquisition de la position..."
                      : "Je suis l'expéditeur (Utiliser ma position actuelle)"}
                  </span>
                </div>
                  ...
                  <>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-semibold text-gray-800">
                            Déposer dans un Point Relais TiiBnTick
                          </span>
                        </div>
                        <input
                          type="checkbox"
                    ...
                    <RelayPointModal
                      ...
                      onSelect={(rp) => {
                        ...
                        setFormData((prev) => ({
                          ...prev,
                          senderAddress: rp.name, // The Relay Point name
                          senderCity: rp.city,
                          senderRegion: rp.region,
                          senderCountry: rp.country,
                    ...
                    {/* ONLY SHOW MANUAL ADDRESS IF NOT USING RELAY POINT */}
                    {!isRelayPoint && (
                            ...
                            >
                              ...
                              {formData.senderCity &&
                                !availableCities.includes(
                                  ...
                                  <option value={formData.senderCity}>
                                    {formData.senderCity}
                                  </option>
                                )}
                            </SelectField>
                        ...
                        <AddressAutocomplete
                          onSelect={(address: any) => {
                            ...
                            setFormData((prev) => ({
                              ...
                              senderRegion:
                                address.district || prev.senderRegion,
                          ...
                          className={
                            errors.senderAddress ? "border-red-300" : ""
                          }
                        />
                ...
                <AnimatePresence>
                  {Object.values(errors).some((error) => error) && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, height: "auto" }}
                      exit={{ opacity: 0, height: 0 }}
                      className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-500/30 rounded-lg p-3"
                    >
                ...
                <div className="pt-4 flex justify-between items-center">
                  {onBack && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="inline-flex items-center px-4 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-lg font-semibold text-sm hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 shadow-sm"
                    >
